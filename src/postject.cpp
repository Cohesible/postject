...
emscripten::val remove_from_elf(const emscripten::val& executable,
                                const std::string& note_name) {
  emscripten::val object = emscripten::val::object();
  object.set("data", emscripten::val::undefined());
...
emscripten::val remove_from_macho(const emscripten::val& executable,
                                  const std::string& segment_name,
                                  const std::string& section_name) {
  emscripten::val object = emscripten::val::object();
  object.set("data", emscripten::val::undefined());
  ...
  for (LIEF::MachO::Binary& binary : *fat_binary) {
    ...
    if (segment) {
      did_change = true;
      binary.remove_command(segment->index());
    }
    ...
    if (existing_section) {
      did_change = true;
      binary.remove_section(segment_name, true);
    }
...
emscripten::val remove_from_pe(const emscripten::val& executable,
                               const std::string& resource_name) {
  emscripten::val object = emscripten::val::object();
  object.set("data", emscripten::val::undefined());
...
EMSCRIPTEN_BINDINGS(postject) {
  ...
  emscripten::function("removeFromELF", &remove_from_elf);
  emscripten::function("removeFromMachO", &remove_from_macho);
  emscripten::function("removeFromPE", &remove_from_pe);
}
